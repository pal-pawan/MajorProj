...
export async function POST(req: Request, res: Response) {
    try {
        ...
        const prompt = `Act as an experienced recruiter and career counselor and craft out a detailed overview of entry-level ${responseData} position. Include the general roles and responsibilities, the expected salary range in India, and the typical interview rounds involved. All without any formatting or markup and make it under 350 words`;
